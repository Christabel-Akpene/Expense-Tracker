  ...
  return (
    ...
    >
      <View className=" items-center">
        ...
        <BodyText className="font-bold text-3xl">Join Spendly</BodyText>
        <BodyText className="my-2">
          Track Your Daily Expenses With Ease
        </BodyText>
        <View className="bg-card shadow-md w-[90%] p-8 rounded-md mt-8">
          <View className="my-2">
            <BodyText className="font-bold text-lg">Username</BodyText>
            <TextInput
              autoCapitalize="none"
              placeholder="Adjoa Manu"
        ...
        <BodyText className="mt-8">
          ...
          <Link href={"/(auth)/login"} className="text-brand">Sign In</Link>
        </BodyText>
      </View>
    </KeyboardAwareScrollView>
  );
